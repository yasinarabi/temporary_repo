...
; (function ($, window, document, undefined) {
    ...
    var templates = {
        ...
        treeviewItemButton: '<a role="button" class="btn mx-2 btn-sm" data-bs-toggle="collapse" data-bs-target>',
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                if (node.buttons){
                    node.buttons.forEach(button => {
                        treeItem.append($(templates.treeviewItemButton).text(button.text)
                            .addClass(`btn-${button.type ? button.type : 'primary'}`)
                            .on("click", function (e) {
                            e.stopPropagation();
                            button.click(node.id);
                        }))
                    });
                }
